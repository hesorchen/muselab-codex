...
window.MUSELAB_STRINGS = {
  zh: {
    ...
    "set.cost.codex_quota_hint": "用量看板显示 Codex 原生账户限额与本地 thread 用量",
  ...
  en: {
    ...
    "set.cost.codex_quota_hint": "The dashboard shows native Codex account limits and local thread usage",
