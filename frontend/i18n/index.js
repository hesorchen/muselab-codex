...
window.MUSELAB_STRINGS = {
  zh: {
    ...
    "set.cost.codex_quota": "Codex 订阅额度",
    "set.cost.codex_quota_hint": "来自本机 Codex 最近一次额度快照",
    "set.cost.codex_quota_empty": "还没有 Codex 额度快照。用 Codex 跑一次请求后这里会显示 5 小时和长周期额度。",
  ...
  en: {
    ...
    "set.cost.codex_quota": "Codex subscription quota",
    "set.cost.codex_quota_hint": "From the latest local Codex quota snapshot",
    "set.cost.codex_quota_empty": "No Codex quota snapshot yet. Send one Codex request and the 5-hour and long-window quota will appear here.",
